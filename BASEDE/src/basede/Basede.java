...
public class Basede extends JFrame {
    ...
    private JButton btnInsertar, btnActualizar, btnEliminar, btnSeleccionar, btnSubirFoto, btnMostrarTabla;
        ...
        layout.setHorizontalGroup(
            layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnMostrarTabla) // Añadir el botón aquí
                )
        );
    ...
    private void subirFotoAction(ActionEvent e) {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                fotoProducto = java.nio.file.Files.readAllBytes(file.toPath());
